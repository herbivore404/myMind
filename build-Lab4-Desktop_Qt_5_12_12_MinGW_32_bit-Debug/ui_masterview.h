...
public:
    ...
    void setupUi(QWidget *MasterView)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/prefix1/img/back.png"), QSize(), QIcon::Normal, QIcon::Off);
        btBack->setIcon(icon);
        ...
        QFont font;
        font.setFamily(QString::fromUtf8("\344\274\230\350\256\276\346\240\207\351\242\230\351\273\221"));
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/img/logout.png"), QSize(), QIcon::Normal, QIcon::Off);
